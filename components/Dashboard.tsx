    ...
    return (
        <div className="p-6 bg-[#0f172a] min-h-screen text-gray-200 pb-24 space-y-8 font-sans">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <StatCard 
                    title="Nuevos (Mes)" 
                    value={newStudentsThisMonth.toLocaleString('es-ES')} 
            ...
            {/* TABLA: Alumnos con Pagos Pendientes - ESTILIZADO */}
            <div className="bg-[#1a2233] p-6 rounded-3xl border border-gray-800/50 shadow-2xl overflow-hidden">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                    <div>
                        <h3 className="text-sm font-black text-white flex items-center gap-3 uppercase tracking-wider">
                            ...
                            Alumnas con Pagos Pendientes ({currentYear})
                        </h3>
                    ...
                    <table className="w-full text-xs text-left border-separate border-spacing-0">
                        <thead className="text-[10px] uppercase font-black text-gray-400 sticky top-0 z-20">
                            <tr className="bg-[#1a2233]/90 backdrop-blur-md">
                                ...
                                <th className="px-6 py-5 border-b border-gray-800/60 tracking-widest text-center">Meses Acumulados</th>
                                ...
                                <tr key={student.id} className="hover:bg-gray-800/40 transition-all duration-200 group">
                                    ...
                                    <td className="px-6 py-5 text-right">
                                        <div className="flex flex-col items-end">
                                            ...
                                            <span className="text-[8px] text-gray-500 uppercase mt-1 font-bold tracking-tighter opacity-70">Total acumulado</span>
                                        </div>
                                    </td>
                                    <td className="px-6 py-5 text-right">
                                        <button 
                                ...
                                <tr>
                                    <td colSpan={4} className="px-6 py-20 text-center">
                                        <div className="flex flex-col items-center gap-3 opacity-40">
                                            ...
                                            <p className="text-gray-400 italic font-bold uppercase tracking-widest text-[10px]">No hay cobros pendientes</p>
                                        </div>
                                    </td>
                                </tr>
                            )}
                ...
                {filteredUnpaidStudents.length > 0 && (
                    <div className="mt-6 flex justify-between items-center px-4 py-3 bg-[#0f172a]/50 rounded-2xl border border-gray-800/50">
                        <div className="flex items-center gap-2">
                            <span className="w-1.5 h-1.5 bg-rose-500 rounded-full animate-pulse"></span>
                            <span className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Encontradas: {filteredUnpaidStudents.length} alumnas</span>
                        </div>
                        <div className="text-right">
                            <span className="text-[10px] font-black text-gray-500 uppercase tracking-widest mr-3">Deuda Total Lista:</span>
                            <span className="text-sm font-black text-rose-400">{formatCurrency(filteredUnpaidStudents.reduce((s, a) => s + a.totalDebt, 0), 2)}</span>
                        </div>
                    </div>
                )}
            </div>
